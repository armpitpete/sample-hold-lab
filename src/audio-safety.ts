...
if (eyebrow) {
  eyebrow.textContent = 'Software Prototype v2.9';
}
...
audioSafetyPanel.innerHTML = `
  <div>
    <p class="audio-safety-kicker">Phase 4 stopped at v2.8</p>
    <h2>Audio Demo / Safety</h2>
    <p class="audio-safety-copy">v2.9 records the decision: future work moves into the manual before more audio features.</p>
  </div>
